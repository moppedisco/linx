...
(function(window) {
    ...
    function newCarousel() {
        ...
        wipeAnimation = new TimelineMax({
            paused: true
        }).fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(1) .carousel__feature__rightcol", 1, {
            autoAlpha: "1",
            x: 0
        }, {
            autoAlpha: "0",
            x: 10,
            ease: Power4.easeInOut
        }, "1").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(2) .carousel__feature__rightcol", 1, {
            autoAlpha: "0",
            x: 10
        }, {
            autoAlpha: "1",
            x: 0,
            ease: Power4.easeInOut
        }, "1+=" + .3).add(pause).to(".desktop-carousel .homepage--carousel__feature:nth-child(2) .carousel__feature__rightcol", 1, {
            autoAlpha: "0",
            scale: .98,
            ease: Power4.easeInOut
        }, "2").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(3) .carousel__feature__rightcol", 1, {
            autoAlpha: "0",
            scale: 1
        }, {
            autoAlpha: "1",
            scale: 1.02,
            ease: Power4.easeInOut
        }, "2").add(pause).to(".desktop-carousel .homepage--carousel__feature:nth-child(3) .carousel__feature__rightcol", 1, {
            autoAlpha: "0",
            ease: Power4.easeInOut
        }, "3").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(4) .carousel__feature__rightcol", 1, {
            autoAlpha: "0"
        }, {
            autoAlpha: "1",
            ease: Power4.easeInOut
        }, "3").add(pause).to(".desktop-carousel .homepage--carousel__feature:nth-child(4) .carousel__feature__rightcol", 1, {
            autoAlpha: "0",
            y: "-20px",
            ease: Power4.easeInOut
        }, "4").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(5) .carousel__feature__rightcol", 1, {
            autoAlpha: "0",
            y: "20px"
        }, {
            autoAlpha: "1",
