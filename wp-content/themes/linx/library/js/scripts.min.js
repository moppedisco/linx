...
(function(window) {
    ...
    function videoHeroPlay() {
        jQuery(".section--video-hero.showBG").each(function(index, element) {
            ...
            videoHero.set(jQuery(element).find(".video-hero__button"), {
                clearProps: "all"
            }).staggerTo(jQuery(element).find(".video-hero-text > *"), .8, {
                y: "-20px",
                autoAlpha: 0,
                ease: Back.easeInOut.config(1.7)
            }, .1).to(jQuery(element).find(".inner-wrap"), .1, {
                css: {
                    zIndex: "-1"
                }
            }).to(jQuery(element).find(".video-hero__bg"), 1, {
                autoAlpha: 0,
                display: "none",
                ease: Power4.easeInOut
            }).to(jQuery(element).find(".video-hero__video"), 1, {
                autoAlpha: 1,
                display: "block",
                ease: Power4.easeInOut
            });
