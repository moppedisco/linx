...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    "use strict";
    var _doc = document.documentElement, _window = _gsScope, _max = function(element, axis) {
        ...
        var rect = _unwrapElement(element).getBoundingClientRect(), isRoot = !container || container === _window || container === document.body, cRect = (isRoot ? _doc : container).getBoundingClientRect(), offsets = {
...
(function(window) {
    ...
    function newCarousel() {
        ...
        }).setPin(".desktop-carousel-nav").addTo(controller);
        var scrollcarousel = new ScrollMagic.Scene({
            triggerElement: ".desktop-carousel",
            triggerHook: "onLeave",
            duration: (carouselItemsTotal - 1) * 100 + "%"
        }).setPin(rightCol).addTo(controller);
            ...
            new ScrollMagic.Scene({
                ...
                if (event.scrollDirection == "FORWARD" && index > 0) {
                    if (index != carouselItemsTotal) {
                        TweenMax.fromTo(jQuery(rightCol).find(".image-box-wrap").eq(index - 1), .5, {
                            autoAlpha: "1"
                        }, {
                            autoAlpha: "0",
                            ease: Power4.easeInOut
                    ...
                    TweenMax.fromTo(jQuery(rightCol).find(".image-box-wrap").eq(index), .5, {
                        autoAlpha: "0"
                    }, {
                        autoAlpha: "1",
                        ease: Power4.easeInOut
