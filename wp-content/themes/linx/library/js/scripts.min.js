(function(root, factory) {
            ...
            if (_pin) {
                ...
                if (reset || !_controller) {
                    ...
                    if (pinTarget.hasAttribute(PIN_SPACER_ATTRIBUTE)) {
                        var style = _pinOptions.spacer.style, values = [ "margin", "marginLeft", "marginRight", "marginTop", "marginBottom" ];
                        margins = {};
    ...
    var _util = ScrollMagic._util = function(window) {
        ...
        var loglevels = [ "error", "warn", "log" ], console = window.console || {};
    ...
    ScrollMagic.Scene.extend(function() {
        ...
        Scene.setTween = function(TweenObject, duration, params) {
            ...
            if (_tween && Scene.controller() && Scene.triggerElement() && Scene.loglevel() >= 2) {
                var triggerTweens = Tween.getTweensOf(Scene.triggerElement()), vertical = Scene.controller().info("vertical");
                triggerTweens.forEach(function(value, index) {
                    var tweenvars = value.vars.css || value.vars, condition = vertical ? tweenvars.top !== undefined || tweenvars.bottom !== undefined : tweenvars.left !== undefined || tweenvars.right !== undefined;
                    if (condition) {
...
(function(window) {
    ...
    function addParallax() {
        ...
        jQuery(".section--text-3-columns.columns--vertical").each(function(index, elem) {
            var tween = new TimelineMax().add([ TweenMax.to(jQuery(elem).find(".text-columns"), 1, {
                y: "-200px",
                ease: Linear.easeNone
            }), TweenMax.to(jQuery(elem).find(".text-columns--image"), 1, {
                y: "-100px",
                ease: Linear.easeNone
            }) ]);
        ...
        jQuery(".section--text-image").each(function(index, elem) {
            var tween = new TimelineMax().add([ TweenMax.to(jQuery(elem).find(".text-image--image").eq(0), 1, {
                y: "-250px",
                ease: Linear.easeNone
            }), TweenMax.to(jQuery(elem).find(".text-image--image").eq(1), 1, {
                y: "-100px",
                ease: Linear.easeNone
            }) ]);
            var scene = new ScrollMagic.Scene({
    ...
    function mobileNav() {
        ...
        slideOut.to(".menu-main-nav", .8, {
            autoAlpha: "0",
            ease: Power4.easeInOut
        }, "one").to("#mobile-navigation-wrapper", .8, {
            x: 0,
            ease: Power4.easeInOut
        }, "one").from(".mobile-background", .8, {
            autoAlpha: 0
        }, "one");
    ...
    function newCarousel() {
        ...
        wipeAnimation = new TimelineMax({
            paused: true
        }).fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(1) .carousel__feature__rightcol", .7, {
            autoAlpha: "1",
            x: 0
        }, {
            autoAlpha: "0",
            x: 10,
            ease: Power4.easeInOut
        }, "1").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(2) .carousel__feature__rightcol", .7, {
            autoAlpha: "0",
            x: 10
        }, {
            autoAlpha: "1",
            x: 0,
            ease: Power4.easeInOut
        }, "1+=" + .3).add(pause).to(".desktop-carousel .homepage--carousel__feature:nth-child(2) .carousel__feature__rightcol", .7, {
            autoAlpha: "0",
            scale: .98,
            ease: Power4.easeInOut
        }, "2").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(3) .carousel__feature__rightcol", 1.2, {
            autoAlpha: "0",
            scale: 1
        }, {
            autoAlpha: "1",
            scale: 1.02,
            ease: Power4.easeInOut
        }, "2").add(pause).to(".desktop-carousel .homepage--carousel__feature:nth-child(3) .carousel__feature__rightcol", 1.2, {
            autoAlpha: "0",
            ease: Power4.easeInOut
        }, "3").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(4) .carousel__feature__rightcol", 1.2, {
            autoAlpha: "0"
        }, {
            autoAlpha: "1",
            ease: Power4.easeInOut
        }, "3").add(pause).to(".desktop-carousel .homepage--carousel__feature:nth-child(4) .carousel__feature__rightcol", 1.2, {
            autoAlpha: "0",
            y: "-20px",
            ease: Power4.easeInOut
        }, "4").fromTo(".desktop-carousel .homepage--carousel__feature:nth-child(5) .carousel__feature__rightcol", 1.4, {
            autoAlpha: "0",
            y: "20px"
        }, {
            autoAlpha: "1",
        ...
        new ScrollMagic.Scene({
            ...
            triggerHook: "onLeave",
            duration: "500%"
        }).setPin(".desktop-carousel").on("progress", function(event) {
            var prog = Math.round(event.progress * 10) / 10;
            prog = Math.round(prog * 5) / 1;
    ...
    function videoHeroPlay() {
        jQuery(".homepage--video-intro.showBG").each(function(index, element) {
            ...
            videoHero.set(jQuery(element).find(".homepage--video-intro-button"), {
                clearProps: "all"
            }).staggerTo(jQuery(element).find(".homepage--video-intro__text > *"), .8, {
                y: "-20px",
                autoAlpha: 0,
                ease: Back.easeInOut.config(1.7)
            }, .1).to(jQuery(element).find(".homepage--video-intro__text"), .1, {
                css: {
                    zIndex: "-1"
                }
            }).to(jQuery(element).find(".homepage--video-intro__video"), 1, {
                autoAlpha: 1,
                ease: Power4.easeInOut
            });
    ...
    function carousel() {
        ...
        var tween = TweenMax.to(".carousel__feature__rightcol", 1, {
            autoAlpha: 1,
            paused: true
        });
        var scroll1;
        ...
        var carousel = new ScrollMagic.Scene({
        ...
        }).setPin(".section--carousel").setTween(tween).on("end", function(event) {
            scroll1 = false;
            scroll2 = false;
            scroll3 = false;
            ...
            if (event.progress > 0 && event.progress < .3 && !scroll1) {
                console.log("1");
                if (event.scrollDirection == "FORWARD") {} else {
                    tl.reverse();
                }
                scroll1 = true;
                scroll2 = false;
                scroll3 = false;
            } else if (event.progress > .3 && event.progress < .6 && !scroll2) {
                ...
                scroll2 = true;
                scroll3 = false;
            } else if (event.progress > .6 && event.progress < 1 && !scroll3) {
                if (event.scrollDirection == "FORWARD") {
                    tl.play();
                } else {}
                console.log("3");
        ...
        }).setClassToggle(".section--carousel", "active").addTo(controller);
        ...
        jQuery(".homepage--carousel__feature").each(function(index, elem) {
            tl.to(jQuery(elem).find(".carousel__feature__rightcol"), .7, {
                autoAlpha: 0
            }).addPause();
    ...
    function stickyNav() {
        var controller = new ScrollMagic.Controller();
        var slideDownNav = TweenMax.to(".menu-main-nav", .8, {
            y: 0,
            top: "0%",
            onReverseComplete: function() {
        ...
        var stickyNav = new ScrollMagic.Scene({
            ...
            triggerHook: "onLeave",
            offset: "700px"
        }).setTween(slideDownNav).on("enter", function() {
