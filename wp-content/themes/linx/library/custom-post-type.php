...
function custom_post_employers() {
	// creating (registering) the custom type
	register_post_type( 'employer', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Employers', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Employer', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Employers', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New Employer', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Employer', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Employer', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Employer', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Employer', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Employers', 'bonestheme' ), /* Search Custom Type Title */
			'not_found' =>  __( 'No Employers created', 'bonestheme' ), /* This displays if there are no entries yet */
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is a Employer listing', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			'publicly_queryable' => true,
			'exclude_from_search' => false,
			'show_ui' => true,
			'query_var' => true,
			'menu_position' => 7, /* this is what order you want it to appear in on the left hand side menu */
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-employer.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'employer', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'employer', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
			'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
...
add_action( 'init', 'custom_post_employers');
...
function custom_post_landingpage() {
	...
	register_post_type( 'landingpage', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-employer.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'sales', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'sales', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
			'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
...
function custom_post_jobs() {
	...
	register_post_type( 'job', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'not_found' =>  __( 'No Job listings created', 'bonestheme' ), /* This displays if there are no entries yet */
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is a job listing', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			'publicly_queryable' => true,
			'exclude_from_search' => false,
			'show_ui' => true,
