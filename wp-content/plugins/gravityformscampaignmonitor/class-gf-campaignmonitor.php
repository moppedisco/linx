...
class GFCampaignMonitor extends GFFeedAddOn {
	...
	public function plugin_settings_fields() {
		return array(
			array(
				...
				'description' => sprintf( esc_html__( 'Campaign Monitor is an email marketing software for designers and their clients. Use Gravity Forms to collect customer information and automatically add it to your client\'s Campaign Monitor subscription list. If you don\'t have a Campaign Monitor account, you can %1$ssign up for one here.%2$s', 'gravityformscampaignmonitor' ),
	...
	public function configure_addon_message() {
		...
		return sprintf( esc_html__( 'We are unable to log in to Campaign Monitor with the provided API key or API Client ID. Please make sure you have entered valid API details on the %s page.', 'gravityformscampaignmonitor' ), $settings_link );
